...
public class UpdateCache implements Runnable {
	...
	public static final String ZIP_URL = "http://client.dragon-ages.org/dragonage.zip";
	public static final String VERSION_URL = "http://client.dragon-ages.org/cacheVersion.txt";
