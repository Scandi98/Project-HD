...
public class SpriteLoader2 {
	...
	public static void loadSprites(StreamLoader archive) {
		try {
			Stream index = new Stream(DataUtils.readFile(signlink.findcachedir() + "Sprites/sprites2.idx"));
			Stream data = new Stream(DataUtils.readFile(signlink.findcachedir() + "Sprites/sprites2.dat"));
	...
	public static boolean dumping = false;//dont we need to make it dump it it did dump sprites.
