...
public final class Stream extends NodeSub {
	...
	public String getString_2() {
		int var2 = this.currentOffset;

		while (this.buffer[this.currentOffset++] != 10) {
			;
		}

		int var3 = this.currentOffset - var2 - 1;
		return var3 == 0 ? "" : method2569(this.buffer, var2, var3,
				(short) 8324);
	}
	...
	public int readUnsignedSmart3(byte b) {
		return 0;
	}
