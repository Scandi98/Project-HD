...
public static String clanFix(String text) {
	text = text.replaceAll("<clan=-1>", "");
	text = text.replaceAll("<clan=0>", "");
	text = text.replaceAll("<clan=1>", "");
	text = text.replaceAll("<clan=2>", "");
	text = text.replaceAll("<clan=3>", "");
	text = text.replaceAll("<clan=4>", "");
	text = text.replaceAll("<clan=5>", "");
	text = text.replaceAll("<clan=6>", "");
	text = text.replaceAll("<clan=7>", "");
	text = text.replaceAll("<clan=8>", "");
	return text;
}
	...
	public void drawString(int drawX, int color, String s, int seed, int drawY)
    {
	 ...
	 public void drawString(boolean flag1, int i, int j, String s, int k)
	    {
	        aBoolean1499 = false;
	        int l = i;
	        if(s == null)
	...
	public void drawString(int i, int j, String s, int l, boolean flag)
    {
        drawString(flag, j - getTextWidth(s) / 2, i, s, l);
    }
}
