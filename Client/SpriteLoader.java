...
public class SpriteLoader {
	...
	public static void loadSprites(StreamLoader archive) {
		try {
			Stream index = new Stream(DataUtils.readFile(signlink.findcachedir() + "Sprites/sprites.idx"));
			Stream data = new Stream(DataUtils.readFile(signlink.findcachedir() + "Sprites/sprites.dat"));
