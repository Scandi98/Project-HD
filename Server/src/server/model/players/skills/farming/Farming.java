...
public class Farming {
	...
	private final static int[] FLOWERS = { 2980, 2981, 2982, 2983, 2984, 2985,
			2986, 2987, 2988 };
	private final static int[] HERBS = { 249, 251, 253, 255, 257, 2998, 259,
			261, 263, 3000, 265, 2481, 267, 269 };
	 ...
	 * Single integars
	 */
	private final static int PATCH_HERBS = 4979;
	private final static int PATCH_CLEAN = 7517;
	...
	private void waterSeed() {
		if (seedPlanted && !seedWatered) {
			...
			updateHerbPatch();
			seedWatered = true;
			c.sendMessage("You water the seed and watch it grow!");
		} else {
	...
	public void updateHerbPatch() {
		if (c.farm[0] > 0 && c.farm[1] > 0 && seedWatered) {
