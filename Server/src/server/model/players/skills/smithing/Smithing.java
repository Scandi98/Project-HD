...
public class Smithing {
	...
	private void CheckAddy(final Client c, final int level,
	...
	private void CheckBronze(final Client c, final int level,
			final int amounttomake, final String type) {
	...
	private void CheckIron(final Client c, final int level,
			final int amounttomake, final String type) {
		remove = 2351;
	...
	private void CheckMith(final Client c, final int level,
			final int amounttomake, final String type) {
		remove = 2359;
	...
	private void CheckRune(final Client c, final int level,
			final int amounttomake, final String type) {
		remove = 2363;
	...
	private void CheckSteel(final Client c, final int level,
			final int amounttomake, final String type) {
		remove = 2353;
	...
	public void doAction(final Client c, final int toadd, final int toremove,
		...
		CycleEventHandler.getSingleton().addEvent(c, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (c.getItems().getItemName(toadd).contains("dart")
						|| c.getItems().getItemName(toadd).contains("bolt")) {
	...
	public void readInput(final int level, final String type, final Client c,
