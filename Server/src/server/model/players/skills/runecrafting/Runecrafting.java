...
public class Runecrafting {
	 ...
	 */
	public int[] altarID = { 14897, 14898, 14899, 14900, 14901, 14902, 14903, 14906,
			14905, 14904, 14907, 14909, 14911 };
	...
	public int[][] craftLevelReq = { { 556, 1 }, { 558, 2 }, { 555, 5 },
			...
			{ 561, 44 }, { 563, 54 }, { 560, 65 }, { 565, 77 }, {9075, 82} };
	...
	public int[] runecraftExp = { 5, 6, 6, 7, 7, 8, 9, 9, 10, 11, 12, 13, 15 };
	...
	private void replaceEssence(int essType, int runeID, int multiplier,
		...
		if (c.inPvP() && c.getWealth() > 500000) {
			c.getPA().addSkillXP(
					(int) 1.5 * (exp * Config.RUNECRAFTING_EXPERIENCE),
