...
public class DoubleDoors {
	...
	public static DoubleDoors getSingleton() {
		if (singleton == null) {
			singleton = new DoubleDoors(Config.LOAD_DIRECTORY + "doubledoors.txt");
		}
		return singleton;
	}
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			Server.gameObjectManager.placeObject(new GameObject(-1, d.x, d.y, d.z, 0, 0, 0));
		}
		...
		Server.gameObjectManager.placeObject(new GameObject(d.doorId, d.x, d.y, d.z, getNextLeftFace(d), 0, 0));
	}
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		Server.gameObjectManager.placeObject(new GameObject(d.doorId, d.x, d.y, d.z, getNextRightFace(d), 0, 0));
	}
