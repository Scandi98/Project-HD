...
public class Doors {
	...
	public static Doors getSingleton() {
		if (singleton == null) {
			singleton = new Doors(Config.LOAD_DIRECTORY + "doors.txt");
		}
		return singleton;
	}
	...
	public boolean handleDoor(int id, int x, int y, int z) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) {
			GameObject o = new GameObject(-1, d.doorX, d.doorY, d.doorZ, 0, d.type, 0);
			Server.gameObjectManager.placeObject(o);
		}
		...
		Server.gameObjectManager.placeObject(new GameObject(d.doorId, d.doorX,
	...
	private static int[] openDoors = { 1504, 1514, 1517, 1520, 1531, 1534,
			...
			10265, 11708, 11710, 11712, 11715, 11994, 12445, 13002, 21399,};
