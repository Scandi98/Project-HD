...
public class RSObjectDefinition {
	...
	public static RSObjectDefinition[] cache = new RSObjectDefinition[20];// gonna try client way... doubt it will work tho but worth a shot
...
//			writer.newLine();
	...
	public static RSObjectDefinition valueOf(int id) {
		...
		//Then how is this reading above that lol
