...
public class EconomyReset
{
        ...
        private static void resetEcoChar(File charFile)
        {
                ...
                {
                        if((!tempData.trim().startsWith("character-item =")) && (!tempData.trim().startsWith("character-bank =") || !tempData.trim().startsWith("character-bank1 =") || !tempData.trim().startsWith("character-bank2 =") || !tempData.trim().startsWith("character-bank3 =") || !tempData.trim().startsWith("character-bank4 =")))
                        {
